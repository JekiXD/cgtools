...
extern "C"
{
  ...
  pub fn add_dropdown( gui : &JsValue, object : &JsValue, property : &str, options : Vec< String > ) -> JsValue;
  ...
  #[ allow( unsafe_code ) ]
  #[ wasm_bindgen( js_name = "onChangeParameter" ) ]
  pub fn on_change_parameter( gui : &JsValue, callback : &web_sys::js_sys::Function );

  #[ allow( unsafe_code ) ]
  #[ wasm_bindgen( js_name = "onChange" ) ]
  pub fn on_change( gui : &JsValue, callback : &web_sys::js_sys::Function );
